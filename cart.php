...
<html>
    <head>
        <meta charset="UTF-8">
        <title>huella luminosa store | Cart</title>
                ...
                <div class="col-sm-10 col-sm-offset-1">
                    <table class="table table-striped">
                        ...
                        if (mysqli_num_rows($result) >= 1) {
                            ...
                            echo "<center><h2><br>Add items to the cart first!</h2><p><a href='products.php'>Click here</a> to explore more items!</p></center>";
                        }
                        ?>
                        <?php
                        ?>
