<nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="index.php" class="navbar-brand"><b>huella luminosa</b></a>
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        if(isset($_SESSION['email'])) {
                            ?>
                        <li><a href="about.php"><span class="glyphicon glyphicon-camera"></span><b> About</b></a></li>
                        ...
                        <li><a href="contact.php"><span class="glyphicon glyphicon-envelope"></span><b> Contact</b></a></li>
